...
hi Normal             guifg=#aaaaaa guibg=#000000 gui=NONE      ctermfg=NONE ctermbg=NONE  cterm=NONE
...
hi Label              guifg=#ffffff guibg=NONE    gui=bold      ctermfg=15   ctermbg=NONE  cterm=bold
hi Keyword            guifg=#ffffff guibg=NONE    gui=bold      ctermfg=15   ctermbg=NONE  cterm=bold

hi Title              guifg=NONE    guibg=NONE    gui=bold      ctermfg=NONE ctermbg=NONE cterm=bold
hi Underlined         guifg=NONE    guibg=NONE    gui=underline ctermfg=NONE ctermbg=NONE cterm=underline

hi htmlTag            guifg=#ffffff guibg=NONE    gui=bold      ctermfg=NONE ctermbg=NONE cterm=bold
hi htmlTagName        guifg=#ffffff guibg=NONE    gui=bold      ctermfg=NONE ctermbg=NONE cterm=bold
hi htmlSpecialTagName guifg=#ffffff guibg=NONE    gui=bold      ctermfg=NONE ctermbg=NONE cterm=bold
hi htmlEndTag         guifg=#ffffff guibg=NONE    gui=bold      ctermfg=NONE ctermbg=NONE cterm=bold
                                                                                                    
hi xmlTag             guifg=#ffffff guibg=NONE    gui=bold      ctermfg=NONE ctermbg=NONE cterm=bold
hi xmlSpecialTagName  guifg=#ffffff guibg=NONE    gui=bold      ctermfg=NONE ctermbg=NONE cterm=bold
hi xmlTagName         guifg=#ffffff guibg=NONE    gui=bold      ctermfg=NONE ctermbg=NONE cterm=bold
hi xmlEndTag          guifg=#ffffff guibg=NONE    gui=bold      ctermfg=NONE ctermbg=NONE cterm=bold
...
hi Include            guifg=NONE    guibg=NONE    gui=bold      ctermfg=NONE ctermbg=NONE cterm=bold
hi Define             guifg=NONE    guibg=NONE    gui=bold      ctermfg=NONE ctermbg=NONE cterm=bold
hi Macro              guifg=NONE    guibg=NONE    gui=bold      ctermfg=NONE ctermbg=NONE cterm=bold
...
hi IncSearch          guifg=#eeff00 guibg=#112200 gui=bold      ctermfg=190  ctermbg=NONE cterm=bold
