...
hi Normal       gui=NONE guifg=#ffffff guibg=#101010 cterm=NONE ctermfg=white ctermbg=black
...
hi Ignore       gui=NONE guifg=#505050 guibg=NONE cterm=NONE ctermfg=darkgrey ctermbg=NONE
hi LineNr       gui=NONE guifg=#505050 guibg=NONE cterm=NONE ctermfg=darkgrey ctermbg=NONE
hi NonText      gui=NONE guifg=#505050 guibg=NONE cterm=NONE ctermfg=darkgrey ctermbg=NONE
hi SpecialKey   gui=NONE guifg=#505050 guibg=NONE cterm=NONE ctermfg=darkgrey ctermbg=NONE
hi Directory    gui=bold guifg=NONE guibg=NONE cterm=bold ctermfg=NONE ctermbg=NONE
hi Search       gui=bold guifg=#f0f040 guibg=#404020 cterm=bold ctermfg=black ctermbg=yellow
hi IncSearch    gui=bold guifg=#f0f040 guibg=#404020 cterm=bold ctermfg=black ctermbg=yellow
...
hi StatusLineNC gui=NONE guifg=#505050 guibg=NONE cterm=NONE ctermfg=darkgrey ctermbg=NONE
hi VertSplit    gui=NONE guifg=#505050 guibg=NONE cterm=NONE ctermfg=darkgrey ctermbg=NONE
hi Visual       gui=NONE guifg=#101010 guibg=#ffffff cterm=NONE ctermfg=black ctermbg=white
hi VisualNOS    gui=NONE guifg=#101010 guibg=#ffffff cterm=NONE ctermfg=black ctermbg=white
hi Folded       gui=NONE guifg=#505050 guibg=NONE cterm=NONE ctermfg=darkgrey ctermbg=NONE
hi FoldColumn   gui=NONE guifg=#505050 guibg=NONE cterm=NONE ctermfg=darkgrey ctermbg=NONE
hi Pmenu        gui=NONE guifg=#ffffff guibg=#202020 cterm=NONE ctermfg=white ctermbg=darkgrey
hi PmenuSel     gui=NONE guifg=#101010 guibg=#ffffff cterm=NONE ctermfg=black ctermbg=white
hi WildMenu     gui=NONE guifg=#101010 guibg=#ffffff cterm=NONE ctermfg=black ctermbg=white
...
hi TabLineSel   gui=NONE guifg=#101010 guibg=#ffffff cterm=NONE ctermfg=black ctermbg=white
hi CursorLine   gui=NONE guifg=#101010 guibg=#ffffff cterm=NONE ctermfg=black ctermbg=white
hi CursorLineNr gui=NONE guifg=#101010 guibg=#ffffff cterm=NONE ctermfg=black ctermbg=white
hi Cursor       gui=NONE guifg=#101010 guibg=#ffffff cterm=NONE ctermfg=black ctermbg=white
...
hi DiffText     gui=NONE guifg=#f0e000 guibg=#202020 cterm=NONE ctermfg=yellow ctermbg=NONE
