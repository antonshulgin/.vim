...
hi Normal             guifg=#dddddd guibg=#111111 gui=NONE ctermfg=white ctermbg=black
hi Comment            guifg=#888888 guibg=NONE    gui=NONE ctermfg=darkgrey
...
hi LineNr             guifg=#444444 guibg=NONE gui=NONE ctermfg=darkgrey
hi NonText            guifg=#222222 guibg=NONE gui=NONE ctermfg=darkgrey
hi SpecialKey         guifg=#222222 guibg=NONE gui=NONE ctermfg=darkgrey

hi Directory          guifg=NONE    guibg=NONE    gui=bold
hi Search             guifg=#332211 guibg=#ffee00 gui=bold ctermfg=black ctermbg=yellow
hi IncSearch          guifg=#332211 guibg=#ffee00 gui=bold ctermfg=black ctermbg=yellow
...
hi Folded             guifg=#444444 guibg=NONE gui=NONE
hi FoldColumn         guifg=#444444 guibg=NONE gui=NONE
