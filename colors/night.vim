...
hi StatusLine   gui=bold guifg=#ffffff guibg=NONE cterm=NONE ctermfg=black ctermbg=white
hi StatusLineNC gui=NONE guifg=#555555 guibg=NONE cterm=NONE ctermfg=darkgrey ctermbg=NONE
hi VertSplit    gui=NONE guifg=#555555 guibg=NONE cterm=NONE ctermfg=darkgrey ctermbg=NONE
...
hi Pmenu        gui=NONE guifg=#ffffff guibg=#111111 cterm=NONE ctermfg=black ctermbg=grey
hi PmenuSel     gui=NONE guifg=#000000 guibg=#ffffff cterm=NONE ctermfg=black ctermbg=white
hi WildMenu     gui=NONE guifg=#000000 guibg=#ffffff cterm=NONE ctermfg=white ctermbg=black
hi TabLine      gui=NONE guifg=NONE guibg=NONE cterm=NONE ctermfg=white ctermbg=NONE
hi TabLineFill  gui=NONE guifg=NONE guibg=NONE cterm=NONE ctermfg=white ctermbg=NONE
...
hi ColorColumn  gui=NONE guifg=NONE guibg=#111111 cterm=NONE ctermfg=white ctermbg=NONE
hi MatchParen   gui=bold guifg=#ff4444 guibg=NONE cterm=NONE ctermfg=white ctermbg=NONE
